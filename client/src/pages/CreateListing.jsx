      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1">
          <input
            type="text"
            placeholder="Name"
            className="p-3 outline outline-1 outline-gray-400"
            id="name"
            maxLength="62"
            minLength="10"
            required
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              className="p-3 outline outline-1 outline-gray-400 w-full"
              type="file"
              id="images"
              accept="image/*"
              multiple
            ...
            <button
              ...
              className="p-3 text-green-700 outline outline-1 outline-green-500 uppercase hover:shadow-lg disabled:opacity-80  hover:bg-green-500 hover:text-green-50"
            >
